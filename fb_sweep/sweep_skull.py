...
def get_birds_grid(args):
    ...
    hyperparams = [
        ...
        hyperparam('--train-views', "0..49"),
        hyperparam('--valid-views', "0..48"),

        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/differentiable_volumetric_rendering/data/DTU/scan65/scan65/bbvoxel0.2.txt"),
        ...
        # use xyz instead of voxel embeddings
        ...
        # hyperparam('--entropy-weight', 5.0, save_dir_key=lambda val: f'ent{val}'),
