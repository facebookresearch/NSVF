...
def get_birds_grid(args):
    ...
    hyperparams = [
        ...
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/differentiable_volumetric_rendering/data/DTU/scan118/scan118/voxel4.txt"),
