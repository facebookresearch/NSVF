...
@register_grid("geo_caterpillar_final2")
def get_caterpillar_final2_grid(args):
    gen_args = {
        'render_resolution': '270x480',
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_up_vector': "(0,-1,0)",
        'render_path_args': "{'radius': 2.5, 'h': 0, 'axis': 'y', 't0': -2, 'r':-1}",
    }
    ...
    hyperparams = [
        ...
        hyperparam('--train-views', "0..322"),
        hyperparam('--valid-views', "322..368"),

        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/final/tanksandtemple_caterpillar/bbvoxel0.16.txt"),
        ...
        hyperparam('--voxel-size', 0.16, save_dir_key=lambda val: f'v{val}'),
...
@register_grid("geo_caterpillar_final")
def get_caterpillar_final_grid(args):
    gen_args = {
        'render_resolution': '270x480',
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_up_vector': "(0,1,0)",
        'render_path_args': "{'radius': 4.5, 'h': 0, 'axis': 'y', 't0': -2, 'r':-1}",
    }
    gen_args = json.dumps(gen_args)
    ...
    hyperparams = [
        ...
        hyperparam('--view-per-batch', 4, save_dir_key=lambda val: f'v{val}'),
        hyperparam('--valid-view-per-batch', 1),
        hyperparam('--train-views', "0..219"),
        hyperparam('--valid-views', "219..251"),

        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/final/blendedmvs_caterpillar/bbvoxel0.4.txt"),
        hyperparam('--quantized-embed-dim', 384, save_dir_key=lambda val: f'emb{val}'),
