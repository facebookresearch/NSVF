...
@register_grid("geo_spring")
def get_ignatius_grid(args):
    gen_args = {
        'render_resolution': '576x768',
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_up_vector': "(0,-1,0)",
        'render_at_vector': "(0.03414456,0.12647211,-0.03312627)",
        'render_path_args': "{'radius': 1.5, 'h': 0.2, 'axis': 'y', 't0': -2, 'r':-1}",
    }
    ...
    hyperparams = [
        ...
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/springs/bbvoxel0.05.txt"),
        ...
        hyperparam('--transparent-background', "0,0,0"),
...
@register_grid("geo_spring_final")
def get_ignatius_grid(args):
    gen_args = {
        'render_resolution': '576x768',
        'render_output_types': ["hit", "rgb", "depth", "normal"],
    ...
    hyperparams = [
        ...
        hyperparam('--view-per-batch', 4, save_dir_key=lambda val: f'v{val}'),
        hyperparam('--valid-view-per-batch', 1),
        hyperparam('--train-views', "0..79"),
        hyperparam('--valid-views', "79..90"),

        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/final/blendedmvs_springs/bbvoxel0.05.txt"),
        ...
        hyperparam('--raymarching-stepsize', 0.00625, save_dir_key=lambda val: f'ss{val}'),
        hyperparam('--voxel-size', 0.05, save_dir_key=lambda val: f'v{val}'),
        hyperparam('--max-hits', 60),
