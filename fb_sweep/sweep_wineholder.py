...
def get_newlego_trans_grid(args):
    ...
    hyperparams = [
       ...
       # model arguments
        ...
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/final/synthetic_wineholder/voxel0.2.txt"),
...
@register_grid("geo_wineholder2")
def get_wineholder2_grid(args):
    gen_args = {
        'render_resolution': "400x400",
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_path_args': "{'radius': 3.5, 'h': 1.5, 'axis': 'z', 't0': -2, 'r':-1}",
    ...
    hyperparams = [
       ...
       # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/wineholder/0000/voxel0.2.txt"),
        hyperparam('--quantized-embed-dim', 3, save_dir_key=lambda val: f'emb{val}'),
...
@register_grid("geo_wineholder4")
def get_wineholder4_grid(args):
    gen_args = {
        'render_resolution': "400x400",
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_path_args': "{'radius': 3.5, 'h': 1.5, 'axis': 'z', 't0': -2, 'r':-1}",
...
@register_grid("geo_wineholder3")
def get_wineholder3_grid(args):
    gen_args = {
        'render_resolution': "400x400",
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_path_args': "{'radius': 3.5, 'h': 1.5, 'axis': 'z', 't0': -2, 'r':-1}",
    ...
    hyperparams = [
       ...
       # model arguments
        ...
        hyperparam('--half-voxel-size-at', ["5000,25000"], save_dir_key=lambda val: "25k25k"),

        # hyperparam('--half-voxel-size-at',  ["5000,25000,75000", "5000,25000", "5000"], 
        #     save_dir_key=lambda val:  "vs{}".format(len(val))),
        hyperparam('--reduce-step-size-at', "5000,25000"),
        # hyperparam('--reduce-step-size-at', 
        #     ["5000,25000,75000", "5000,25000", "5000", ""], 
        #     save_dir_key=lambda val: "rs{}".format(len(val))),
        hyperparam('--use-max-pruning', binary_flag=True, save_dir_key=lambda val: 'maxp'),
        hyperparam('--total-num-embedding', 60000, save_dir_key=lambda val: '60k'),
    ...
    hyperparams += [
        hyperparam('--restore-file', 
            "/checkpoint/jgu/space/neuralrendering/debug_new_singlev3/geo_wineholder2_latest.single.800x800.s1.v4.geo_nerf.emb384.ss0.025.v0.2.posemb.sdfh128.raydir.r24.bg1.0.bgsg.dis.prune2500.th0.5.dyvox.maxp.60k.p16384.chk512.rgb128.0.alpha1.0.adam.lr_poly.max150000.lr0.001.clip0.0.wd0.0.seed20.ngpu8/checkpoint15.pt"
        )
    ]
    return hyperparams
