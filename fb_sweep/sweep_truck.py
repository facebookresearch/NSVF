...
@register_grid("geo_truck_final2")
def get_truck_final2_grid(args):
    gen_args = {
    ...
    hyperparams = [
        ...
        hyperparam('--train-views', "0..218"),
        hyperparam('--valid-views', "218..250"),

        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/final/tanksandtemple_truckv2/bbvoxel0.16.txt"),
...
@register_grid("geo_truck_final")
def get_truck_final_grid(args):
    gen_args = {
        'render_resolution': '270x480',
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_up_vector': "(0,1,0)",
    ...
    hyperparams = [
        ...
        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/final/blendedmvs_truck/bbvoxel0.4.txt"),
        hyperparam('--quantized-embed-dim', 384, save_dir_key=lambda val: f'emb{val}'),
