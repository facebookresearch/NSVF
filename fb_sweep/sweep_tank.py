...
def get_ignatius_grid(args):
    ...
    hyperparams = [
        ...
        # task level
        hyperparam('--view-resolution', '540x1024', save_dir_key=lambda val: f'{val}'),
        ...
        hyperparam('--train-views', "0..313"),
        hyperparam('--valid-views', "0..288:4"),

        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/m60_srn/bbvoxel0.4.txt"),
        ...
        # training arguments
        hyperparam('--pixel-per-view', 1024, save_dir_key=lambda val: f'p{val}'),
