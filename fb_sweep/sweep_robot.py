...
@register_grid("geo_robot")
def get_robot_grid(args):
    gen_args = {
        'render_resolution': "400x400",
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_path_args': "{'radius': 10.5, 'h': 1.5, 'axis': 'z', 't0': -2, 'r':-1}",
    }
    ...
    hyperparams = [
       ...
       # model arguments
        ...
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/robot/0000/voxel2.txt"),
        ...
        hyperparam('--voxel-size', 0.8, save_dir_key=lambda val: f'v{val}'),
