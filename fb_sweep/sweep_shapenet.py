...
def get_shapenet_seq1282_grid(args):
    ...
    hyperparams = [
        ...
        hyperparam('--raymarching-stepsize', 0.03125, save_dir_key=lambda val: f'ss{val}'),
        hyperparam('--voxel-size', 0.0625, save_dir_key=lambda val: f'v{val}'),
...
def get_shapenet_seq128fs_grid(args):
    ...
    hyperparams += [
        hyperparam('--restore-file',
            "/checkpoint/jgu/space/neuralrendering/debug_new_chairsv2/srn_data_v5.fp16.seq.128x128.s16.v1.geo_nerf.hpc.emb384.id.ss0.03125.v0.0625.posemb.sdfh128.bg1.0.dis.dstep.pruning.cm.dyvox.fv.p2048.smk0.9.chk512.rgb128.0.alpha1.0.latent1.0.vgg0.0.adam.lr_poly.max200000.lr0.001.seed2.ngpu8/checkpoint_last.pt")
    ]
    return hyperparams
