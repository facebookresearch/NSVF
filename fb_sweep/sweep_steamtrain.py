...
@register_grid("geo_steamtrain")
def get_steamtrain_grid(args):
    gen_args = {
        'render_resolution': "400x400",
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_path_args': "{'radius': 12.5, 'h': 1.5, 'axis': 'z', 't0': -2, 'r':-1}",
    }
    ...
    hyperparams = [
       ...
       # model arguments
        ...
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/steamtrain/0000/voxel2.txt"),
...
@register_grid("geo_steamtrain1")
def get_steamtrain1_grid(args):
    gen_args = {
        'render_resolution': "400x400",
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_path_args': "{'radius': 12.5, 'h': 1.5, 'axis': 'z', 't0': -2, 'r':-1}",
