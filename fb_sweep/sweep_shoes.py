...
def get_ignatius_grid(args):
    ...
    hyperparams = [
        ...
        hyperparam('--train-views', "0..28"),
        hyperparam('--valid-views', "0..24"),

        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/shoes/newvoxel0.4.txt"),
