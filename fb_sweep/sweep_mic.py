...
@register_grid("geo_mic")
def get_mic_grid(args):
    gen_args = {
    ...
    hyperparams = [
       ...
       # model arguments
        ...
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/mic_full/voxel.txt"),
        ...
        hyperparam('--half-voxel-size-at', "5000,25000,50000,75000", save_dir_key=lambda val: f'dy2'),
    ...
    hyperparams += [
        hyperparam('--restore-file', 
            "/checkpoint/jgu/space/neuralrendering/debug_new_singlev3/geo_micv1.single.800x800.s1.v4.geo_nerf.emb384.ss0.05.v0.4.posemb.sdfh128.raydir.r24.bg1.0.bgsg.dis.prune2500.th0.5.dyvox.maxp.60k.p2048.chk512.rgb128.0.alpha1.0.vgg1.0.l3.adam.lr_poly.max150000.lr0.001.clip0.0.wd0.0.seed20.ngpu8/checkpoint10.pt"
        )
    ]
...
@register_grid("geo_mic2")
def get_mic2_grid(args):
    gen_args = {
        'render_resolution': "400x400",
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_path_args': "{'radius': 3.5, 'h': 1.5, 'axis': 'z', 't0': -2, 'r':-1}",
    ...
    hyperparams = [
       ...
       # model arguments
        ...
        hyperparam('--pruning-th', 0.5, save_dir_key=lambda val: f'th{val}'),
        # hyperparam('--half-voxel-size-at', "5000,25000,75000", save_dir_key=lambda val: f'dyvox'),
        hyperparam('--half-voxel-size-at', "5000,25000,75000", save_dir_key=lambda val: f'dy2'),
        hyperparam('--reduce-step-size-at', "5000,25000,75000"),
        hyperparam('--use-max-pruning', binary_flag=True, save_dir_key=lambda val: 'maxp'),
        hyperparam('--total-num-embedding', 60000, save_dir_key=lambda val: '60k'),
