...
@register_grid("geo_twopeople")
def get_ignatius_grid(args):
    gen_args = {
        'render_resolution': '576x768',
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_up_vector': "(0,1,0)",
        'render_at_vector': "(-0.12733514, 0.36198423, 0.32331808)",
        'render_path_args': "{'radius': 4.0, 'h': 0, 'axis': 'y', 't0': -2, 'r':-1}",
    }
    ...
    hyperparams = [
        ...
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/twopeople/bbvoxel0.16.txt"),
...
@register_grid("geo_twopeople_final")
def get_2ppl_grid(args):
    gen_args = {
        'render_resolution': '576x768',
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_up_vector': "(0,1,0)",
    ...
    hyperparams = [
        ...
        # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/final/blendedmvs_twopeople/bbvoxel0.1.txt"),
...
@register_grid("geo_twopeople_final2")
def get_2ppl2_grid(args):
    gen_args = {
        'render_resolution': '576x768',
        'render_output_types': ["hit", "rgb", "depth", "normal"],
        'render_up_vector': "(0,1,0)",
    ...
    hyperparams = [
        ...
        hyperparam('--total-num-embedding', 150000, save_dir_key=lambda val: '100k'),
        hyperparam('--use-max-pruning', binary_flag=True),
