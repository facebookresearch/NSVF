...
def get_newlego_trans_grid(args):
    ...
    hyperparams = [
        ...
        # task level
        hyperparam('--view-resolution', "400x400", save_dir_key=lambda val: f'{val}'),
        ...
        hyperparam('--valid-views', "44..300:8"),
        
       # model arguments
        hyperparam('--arch', 'geo_nerf', save_dir_key=lambda val: val),
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/candle/voxel.txt"),
        ...
        hyperparam('--raydir-features', 72, save_dir_key=lambda val: f'r{val}'),
