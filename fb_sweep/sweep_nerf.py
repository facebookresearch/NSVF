...
def get_hotdog_reload_grid(args):
    ...
    hyperparams = [
        ...
        hyperparam('--max-train-view', 100),
        # hyperparam('--max-valid-view', 100),
        hyperparam('--pruning-every-steps', 3000, save_dir_key=lambda val: f'prune{val}'),
    ...
    hyperparams += [
        hyperparam('--restore-file', 
            ...
            "debug_nerf_hotdog2/hotdog2ver2.fp16.single.400x400.s1.v1.prune3000.th0.375.p16384.ss0.005.chk512.p.rgb200.0.vgg1.0.geo_nerf_dyn.sdfh128.posemb.emb378.v0.06.bg1.0.bgsg.dis.aabb.raydir.r24.adam.lr_poly.max100000.lr0.001.clip0.0.wd0.0.seed20.ngpu8/" + 
