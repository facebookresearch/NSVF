...
def get_hotdog_reload_grid(args):
    hyperparams = get_hotdog_grid(args)
    hyperparams += [
        hyperparam('--restore-file', 
            "/checkpoint/jgu//space/neuralrendering/" + 
            "debug_nerf_hotdog/hotdog2_bbox.fp16.single.400x400.s1.v1.p16384.mask0.5.bbox.stepsize0.005." + 
            "chk512.p.rgb200.0.vgg1.0.geo_nerf_tri.sdfh128.posemb.sub0.emb378.v0.06.bg1.0.bgsg.dis.dstep.aabb." + 
            "raydir.r24.adam.lr_poly.max100000.lr0.001.clip0.0.wd0.0.seed20.ngpu8/" + 
            "checkpoint2.pt", save_dir_key=lambda val: "re"),
