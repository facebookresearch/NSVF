...
@register_grid("geo_materials")
def get_materials_grid(args):
    gen_args = {
    ...
    hyperparams = [
       ...
       # model arguments
        ...
        hyperparam('--quantized-voxel-path', "/private/home/jgu/data/shapenet/materials/voxel.txt"),
