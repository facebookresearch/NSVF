# just for debugging
DATA=tanksandtemple_truckv2
DATASET=/private/home/jgu/data/shapenet/final/${DATA}
MODEL_ROOT=/checkpoint/jgu/space/neuralrendering/debug_new_singlev3/
MODEL_PATH="geo_truck_final2v3.fp16.single.1080x1920.s1.v4.geo_nerf.emb384.ss0.02.v0.16.posemb.sdfh128.raydir.r24.bg1.0.bgsg.dis.prune2500.th0.5.dyvox.80k.maxp.p2048.chk512.rgb128.0.alpha1.0.adam.lr_poly.max100000.lr0.001.clip0.0.wd0.0.seed20.ngpu8"
FACTOR=${2:-6400}
GAMMA=${3:-0.01}
RES=1080x1920
GPU=${1:-0}
...
#     --render-resolution ${RES} \
#     --render-at-vector "(-0.16499998312730058, -0.19763899525006615, -0.011375018187931676)" \
#     --render-up-vector "(0,-1,0)" \
#     --render-path-args "{'radius': 1.6, 'h': 0.02, 'axis': 'y', 't0': -2, 'r':-1}" \
