...
MODEL_PATH="geo_family2v1.single.1080x1920.s1.v4.geo_nerf.emb32.ss0.01.v0.08.posemb.sdfh128.raydir.r24.addpos6.bg1.0.bgsg.dis.prune2500.th0.5.dyvox.80k.maxp.p2048.chk512.rgb128.0.alpha1.0.adam.lr_poly.max100000.lr0.001.clip0.0.wd0.0.seed20.ngpu8"
MODEL_PATH="geo_family3_resume.single.1080x1920.s1.v4.geo_nerf.emb32.addpos6.ss0.01.v0.08.posemb.sdfh128.raydir.r24.bg1.0.bgsg.dis.prune2500.th0.5.dyvox.80k.maxp.p2048.chk512.rgb128.0.alpha1.0.adam.lr_poly.max150000.lr0.001.clip0.0.wd0.0.seed20.ngpu8"
...
#     --render-resolution ${RES} \
#     --render-at-vector "(-0.02396100316728863,0.08461899008069718,-0.049248005492346605)" \
#     --render-up-vector "(0,1,0)" \
#     --render-path-args "{'radius': 0.5, 'h': 0.0, 'axis': 'y', 't0': -2, 'r':-1}" \
#     --render-output ${MODEL_ROOT}/supplemental/${DATA}_circle_better/ \
#     --render-output-types "rgb" "depth" "hit" "normal" \
#     --model-overrides "{'fp16': False, 'aabb_factor': ${FACTOR}, 'raymarching_tolerance': ${GAMMA}}" \
#     --render-combine-output
...
pushd ${MODEL_ROOT}/supplemental/${DATA}_circle_better
ffmpeg -framerate 20 -pattern_type glob -i 'rgb/*.png' rgb.mp4
zip -r ${DATA}_circle_better_rgb.zip rgb/*.png rgb.mp4
# zip -r ${DATA}_circle_pose.zip pose/*.txt 

bash ~/tools/Dropbox-Uploader/dropbox_uploader.sh upload ${DATA}_circle_better_rgb.zip NeurIPS2020/SupplementalMaterials/results/nsvf/
