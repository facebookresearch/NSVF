...
SAVE=/checkpoint/jgu/space/neuralrendering/new_test/model_wineholder_low
ARCH=nsvf_base
...
python train.py ${DATASET} \
    ...
    --arch $ARCH \
    --initial-boundingbox ${DATASET}/bbox_fine.txt \
    --raymarching-stepsize 0.003125 \
    ...
    --keep-interval-updates 5 --keep-last-epochs 3 \
