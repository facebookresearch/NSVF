...
MODEL_PATH="geo_mic2vhp2.single.800x800.s1.v4.geo_nerf.emb32.ss0.05.v0.4.posemb.sdfh128.raydir.r24.addpos6.bg1.0.bgsg.dis.prune2500.th0.5.dy2.maxp.60k.p2048.chk512.rgb128.0.alpha1.0.vgg1.0.l3.adam.lr_poly.max150000.lr0.001.clip0.0.wd0.0.seed20.ngpu8"
FACTOR=${2:-8000}
GAMMA=${3:-0.01}
GPU=${1:-0}
